              ...
              <div key={item.id}>
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:px-[1rem] md:px-[4rem] lg:px-[4rem] sm:mb-[3rem] md:mb-[3rem] lg:mb-[5rem]">
                  <div className="flex items-center">
                    <Image src={saveWaterIcon} className="sm:w-[60px] md:w-auto" /> <span className="ms-4 sm:text-[11px] md:text-[12px] lg:text-[14px]">{item.productBenefitOne}</span>
                  </div>
                  <div className="flex items-center">
                  ...
                  <div className="sm:col-span-2 md:col-span-3">
                    <div className="flex items-center">
                      <Image src={airFlowIcon} className="sm:w-[40px] md:w-[50px] lg:w-auto sm:ms-[0.5rem]" /> <span className="ms-4 sm:text-[11px] md:text-[12px] lg:text-[14px]">{item.productBenefitSeven}</span>
                    </div>
                  </div>
                </div>
